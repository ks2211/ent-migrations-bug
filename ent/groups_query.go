...
func (gq *GroupsQuery) QueryTenant() *TenantQuery {
...
func (gq *GroupsQuery) WithTenant(opts ...func(*TenantQuery)) *GroupsQuery {
	query := &TenantQuery{config: gq.config}
...
func (gq *GroupsQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Groups, error) {
	...
	_spec.Node.Schema = gq.schemaConfig.Groups
...
func (gq *GroupsQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1.Schema(gq.schemaConfig.Groups)
	ctx = internal.NewSchemaConfigContext(ctx, gq.schemaConfig)
