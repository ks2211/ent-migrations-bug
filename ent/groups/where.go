...
func TenantID(v int) predicate.Groups {
	return predicate.Groups(func(s *sql.Selector) {
...
func TenantIDEQ(v int) predicate.Groups {
	return predicate.Groups(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldTenantID), v))
	})
}
...
func TenantIDNEQ(v int) predicate.Groups {
	return predicate.Groups(func(s *sql.Selector) {
...
func TenantIDIn(vs ...int) predicate.Groups {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func TenantIDNotIn(vs ...int) predicate.Groups {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func HasTenant() predicate.Groups {
	return predicate.Groups(func(s *sql.Selector) {
...
func HasTenantWith(preds ...predicate.Tenant) predicate.Groups {
	return predicate.Groups(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
